...
It would show the image with the slider, but then a bunch of other duplicate images of the first frame would show up below that.
I used Gemini to try and help me debug what was going on, but nothing worked.
After a while I gave up and loaded the \lstinline{.ipynb} into a Google Colab environment and the original code worked perfectly fine.
It seems to be a common issue with VS code, and I thought it wasn't worth my time trying to figure that out.
